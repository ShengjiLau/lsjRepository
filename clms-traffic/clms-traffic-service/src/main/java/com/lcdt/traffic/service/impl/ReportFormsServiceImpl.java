...
public class ReportFormsServiceImpl implements ReportFormsService {
    ...
    public Map customerPlanStatistics(Map map) {
        ...
        List<Map<String,Object>> mapList = reportFormsMapper. selectCustomerPlanData(map);     //统计详情查询用来做折线的数据
    ...
    public Map queryOwnWaybillStatistics(Map map) {
        ...
        List<Map<String,Object>> mapList = reportFormsMapper.selectOwnWaybillData(map);     //统计详情查询用来做折线的数据
        map1.put("detail",mapList);
        return map1;
    }
    ...
    public Map queryCustomerWaybillStatistics(Map map) {
        ...
        Map<String,Object> map1 = reportFormsMapper.selectCustomerWaybill(map);
        if (null == map1) {
            map1 = new HashMap<>();
            map1.put("daifahuo", 0);
            map1.put("yiruchang", 0);
        ...
        List<Map<String,Object>> mapList = reportFormsMapper.selectCustomerWaybillData(map);     //统计详情查询用来做折线的数据
        map1.put("detail",mapList);
        return map1;
    }
