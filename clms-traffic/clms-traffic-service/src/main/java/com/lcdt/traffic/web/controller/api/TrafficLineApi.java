...
public class TrafficLineApi {
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('')")
...
//        old.setLineName(line.getLineName());
//        old.setLineEndCity(line.getLineEndCity());
//        old.setLineEndProvince(line.getLineEndProvince());
//        old.setLineStartCity(line.getLineStartCity());
//        old.setLineStartProvince(line.getLineStartProvince());
//        old.setLineStatus(line.getLineStatus());
