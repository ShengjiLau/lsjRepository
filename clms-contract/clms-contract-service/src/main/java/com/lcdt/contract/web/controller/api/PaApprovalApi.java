...
public class PaApprovalApi {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('payment_approval_list')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('payment_approval_operate')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('payment_approval_revoke')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('payment_approval_cc')")
