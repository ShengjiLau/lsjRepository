...
public class SalesPaApprovalApi {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('sales_receipt_approval_list')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('sales_receipt_approval_operate')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('sales_receipt_approval_revoke')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('sales_receipt_approval_cc')")
