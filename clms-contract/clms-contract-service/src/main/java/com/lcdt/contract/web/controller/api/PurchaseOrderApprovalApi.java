 ...
 * @DATE 2018-03-01
 */
@Api(description = "采购单审批api")
@RestController
@RequestMapping("/purchase/order_approval")
public class PurchaseOrderApprovalApi {

    Logger logger = LoggerFactory.getLogger(PurchaseOrderApprovalApi.class);

    @Autowired
    private OrderApprovalService orderApprovalService;


    @ApiOperation(value = "采购单审批列表", notes = "采购单审批列表")
    @GetMapping("/list")
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('purchase_order_approval_list')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('purchase_order_approval_agree')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('purchase_order_approval_reject')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('purchase_order_approval_revoke')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('purchase_order_approval_turnDo')")
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('purchase_order_approval_cc')")
