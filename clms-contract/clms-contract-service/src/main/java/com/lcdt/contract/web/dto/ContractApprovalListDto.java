...
public class ContractApprovalListDto implements Serializable{
    ...
    public Date getApprovalEndtDate() {
        return approvalEndtDate;
    }

    public void setApprovalEndtDate(Date approvalEndtDate) {
        this.approvalEndtDate = approvalEndtDate;
    }
