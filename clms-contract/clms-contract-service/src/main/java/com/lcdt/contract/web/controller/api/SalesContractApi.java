...
//        dto.setPartyBName(user.getRealName());
    ...
    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('sales_contract_log_list')")
...
//    @PreAuthorize("hasRole('ROLE_SYS_ADMIN') or hasAuthority('sales_contract_attachment_modify')")
