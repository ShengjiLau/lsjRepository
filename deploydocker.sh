...
docker run -d --name=userservice --restart=always -e "ZKHOST=172.17.0.3:2181" -e "ssoserverlogin=http://login.datuodui.com:52412/account" -p 52411:52411 localhost:5000/test-user-service
exit
remotessh
