...
/**
 * Created by ss on 2018/5/4.
 */
public class Mpgenerator {

	static String  packagePath = "clms-warehouse-manage/mybatis-plus-generate";

	static File file = new File(packagePath);
...
//		strategy.setTablePrefix(new String[] { "tlog_", "tsys_" });// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "attachment" }); // 需要生成的表
		...
		focList.add(new FileOutConfig("/template/list.jsp.vm") {
			...
			public String outputFile(TableInfo tableInfo) {
				// 自定义输入文件名称
				return  tableInfo.getEntityName() + ".jsp";
			}
		});
...
//		System.getProperty("user.dir");
		return packagePath + "/src/main/java/com/lcdt/code/generate";
//		return "/";
//		return path;
	}
