 ...
 */
@Configuration
@DubboComponentScan(basePackages = {"com.lcdt.driver.wechat.api","com.lcdt.*.service","com.lcdt.*.service.impl","com.lcdt.clms.*.service.impl","com.lcdt.*.rpcserviceImpl","com.lcdt.*.rpc.impl","com.lcdt.*.rpc","com.lcdt.userinfo.controller.api"})
